...
static func dry_run(world: Object, request: Dictionary) -> Dictionary:
	...
	return WorldOpResultScript.dry_run(TYPE, lines, {"package_id": package_id, "would_set_enabled": false, "previous_state": previous_state}, preview_diff, _rollback_hint(package_id))
